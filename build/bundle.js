    ...
    (() => {
                  ...
                  if (/[.0-9]/.test(e[this.getIndex() - 1]))
                    ...
                    var o =
                      "+" === e[this.getIndex() - 1]
                        ...
                        : this.current >= 0
                        ? "-".concat(this.current)
                        : "+".concat(this.current.toString().slice(1));
                    a.splice(
                      this.getIndex() - 1,
                      "".concat(e).length,
                      o.toString()
      ...
      var O = (function () {
                ...
                switch (t) {
                  ...
                  case "number":
                    "x^(1/y)" === e &&
                      ...
                      r.getIsEddit()
                        ? (l.addingWithsymbol(r), (n = { status: "ok" }))
                        : (!/[.0-9]/.test(l.value) &&
                            /[0-9]/.test(r.getString())) ||
                          "^(1/" === l.value
                        ? (l.addingWithsymbol(r),
                          (n = { status: "ok" }),
                          r.changeIsEdit(!0))
                        : (r.changeIsEdit(!0),
          ...
          return (
            ...
            (t = [
              {
                key: "addingWithsymbol",
                value: function (n) {
                  if (/[-+*/^]/.test(this.value) && 1 === this.value.length)
                    /[-+*/^]/.test(n.getString()[n.getString().length - 1])
                      ? n.setString(
                          d(
                            n.getString().slice(0, n.getString().length - 1),
                            this.value
                          )
                        )
                      : n.setString(d(n.getString(), this.value));
                  else if ("." === this.value) {
                    var e = n.getString(),
                      t = n.findIndexWithMark(e.length - 1, e);
                    -1 === e.slice(t).indexOf(".") &&
                      n.setString(d(e, this.value));
                  } else
                    console.log(d(n.getString(), this.value)),
                      n.setString(d(n.getString(), this.value));
                },
              },
            ]),
      ...
      (J.styleTagTransform = V()),
        ...
        (function (n) {
          ...
          for (var l = 0; l < 10; l++)
            i.push(new O(l, "number", n, null, r, c)),
          ...
          var d = new O("+", "number", n, null, r, c),
            h = new O("-", "number", n, null, r, c),
            g = new O("*", "number", n, null, r, c),
            b = new O(".", "number", n, null, r, c),
            m = new O("/", "number", n, null, r, c),
            f = new O("^", "number", n, null, r, c),
            C = new O("%", "action", n, new B(), r, c),
            E = new O("+/-", "action", n, new k(), r, c),
            j = new O("x^2", "action", n, new x(), r, c),
            Y = new O("x^3", "action", n, new v(), r, c),
            M = new O("10^x", "action", n, new y(), r, c),
            T = new O("1/x", "action", n, new _(), r, c),
            Z = new O("x^(1/y)", "number", n, null, r, c),
            L = new O("x^(1/2)", "action", n, new S(), r, c),
            D = new O("x^(1/3)", "action", n, new I(), r, c),
            N = new O("!", "action", n, new W(), r, c),
            q = new O("=", "action", n, new w("="), r, c, a),
            P = new O("(", "bracketOpen", n, null, r, c),
            U = new O(")", "bracketClose", n, new w(")"), r, c),
            R = new O("MC", "memory", n),
            X = new O("MR", "memory", n, null, r, c),
            F = new O("M+", "memory", n, new w("M+")),
            V = new O("M-", "memory", n, new w("M-")),
            H = new O("AC", "memory", n, null, r, c);
          o.append(P.element),
            o.append(U.element),
            o.append(R.element),
            o.append(H.element),
            ...
            o.append(q.element);
          var J = new O("Вернуть", "undo", n, new z(), r, c);
          t.append(r),
            t.append(c),
            t.append(o),
            e.append(t),
